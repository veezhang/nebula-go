...
var schemaIDPool = autopool.AutoPool[SchemaID]{
	New: func() *SchemaID {
		return &SchemaID{}
	},
	Reset: func(v *SchemaID) {
		v.TagID = nil
		v.EdgeType = nil
	},
}
...
var dataPool = autopool.AutoPool[Date]{
	New: func() *Date {
		return &Date{}
	},
	Reset: func(v *Date) {
...
var timePool = autopool.AutoPool[Time]{
	New: func() *Time {
		return &Time{}
	},
	Reset: func(v *Time) {
...
var dateTimePool = autopool.AutoPool[DateTime]{
	New: func() *DateTime {
		return &DateTime{}
	},
	Reset: func(v *DateTime) {
		v.Year = 0
		v.Month = 0
		v.Day = 0
		v.Hour = 0
...
var valuePool = autopool.AutoPool[Value]{
	New: func() *Value {
		return &Value{}
	},
	Reset: func(v *Value) {
...
var nListPool = autopool.AutoPool[NList]{
	New: func() *NList {
		return &NList{}
	},
	Reset: func(v *NList) {
...
var nMapPool = autopool.AutoPool[NMap]{
	New: func() *NMap {
		return &NMap{}
	},
	Reset: func(v *NMap) {
...
var nSetPool = autopool.AutoPool[NSet]{
	New: func() *NSet {
		return &NSet{}
	},
	Reset: func(v *NSet) {
...
var rowPool = autopool.AutoPool[Row]{
	New: func() *Row {
		return &Row{}
	},
	Reset: func(v *Row) {
...
var dataSetPool = autopool.AutoPool[DataSet]{
	New: func() *DataSet {
		return &DataSet{}
	},
	Reset: func(v *DataSet) {
		v.ColumnNames = v.ColumnNames[:0]
		for i := range v.Rows {
			v.Rows[i] = nil
		}
		v.Rows = v.Rows[:0]
...
var tagPool = autopool.AutoPool[Tag]{
	New: func() *Tag {
		return &Tag{}
	},
	Reset: func(v *Tag) {
...
var vertexPool = autopool.AutoPool[Vertex]{
	New: func() *Vertex {
		return &Vertex{}
	},
	Reset: func(v *Vertex) {
...
var edgePool = autopool.AutoPool[Edge]{
	New: func() *Edge {
		return &Edge{}
	},
	Reset: func(v *Edge) {
...
var stepPool = autopool.AutoPool[Step]{
	New: func() *Step {
		return &Step{}
	},
	Reset: func(v *Step) {
...
var pathPool = autopool.AutoPool[Path]{
	New: func() *Path {
		return &Path{}
	},
	Reset: func(v *Path) {
...
var keyValuePool = autopool.AutoPool[KeyValue]{
	New: func() *KeyValue {
		return &KeyValue{}
	},
	Reset: func(v *KeyValue) {
		v.Key = v.Key[:0]
		v.Value = v.Value[:0]
	},
}
...
var durationPool = autopool.AutoPool[Duration]{
	New: func() *Duration {
		return &Duration{}
	},
	Reset: func(v *Duration) {
		v.Seconds = 0
		v.Microseconds = 0
		v.Months = 0
	},
